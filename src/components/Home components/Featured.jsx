    ...
    <div className="Backdrop">
      ...
      <section>
        <div className="Item FeaText">
          ...
          <p>
            "Avo Traveler has helped me see the world while creating the least
            harm to the enviornment. Any time I plan a trip I check Avo Traveler
            first."
            <br />- Johnathon Dragomir
          </p>
